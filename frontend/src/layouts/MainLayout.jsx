...
const navigation = [
  ...
  },
  {
    ...
    icon: BarChart3,
    children: [
      { name: 'Channel Analytics', href: '/reports/analytics?groupBy=channel', icon: BarChart3 },
      { name: 'Country Analytics', href: '/reports/analytics?groupBy=country', icon: Globe },
      { name: 'Device Analytics', href: '/reports/analytics?groupBy=device_type', icon: Shield },
      { name: 'Keyword Analytics', href: '/reports/analytics?groupBy=keyword', icon: Search },
      { name: 'Subchannel Analytics', href: '/reports/analytics?groupBy=subchannel', icon: BarChart3 },
      { name: 'Landing Page', href: '/reports/analytics?groupBy=landing_page', icon: FileText },
    ],
  },
  {
    name: 'Tools',
